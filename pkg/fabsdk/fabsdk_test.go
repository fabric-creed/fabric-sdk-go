...
import (
	...
	discmocks "github.com/JieWaZi/fabric-sdk-go/pkg/fab/discovery/mocks"
	"github.com/JieWaZi/fabric-sdk-go/pkg/fab/mocks"
	"github.com/JieWaZi/fabric-sdk-go/pkg/fabsdk/factory/defsvc"
	"github.com/JieWaZi/fabric-sdk-go/pkg/fabsdk/provider/chpvdr"
	mockapisdk "github.com/JieWaZi/fabric-sdk-go/pkg/fabsdk/test/mocksdkapi"
	"github.com/JieWaZi/fabric-sdk-go/pkg/msp"
...
func TestErrorHandler(t *testing.T) {
	...
	errHandler := func(ctxt fab.ClientContext, channelID string, err error) {
		...
		//https://github.com/JieWaZi/fabric-sdk-go/pull/62#issuecomment-605343770
